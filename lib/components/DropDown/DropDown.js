...
var DropDown = function (_Component) {
	...
	(0, _createClass3.default)(DropDown, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ ref: function ref(container) {
						...
						}, className: (0, _classNames2.default)('drop-container', placement) },
					_react2.default.createElement(
						_Menu2.default,
						{ ref: function ref(menu) {
								return _this2.menu = menu;
							}, className: 'drop-menu', style: { maxHeight: maxHeight }, onChange: function onChange(e, value) {
		...
		value: function getHiddenMenuOffset() {
			...
			if (maxHeight < this.menu.clientHeight + 20 && cords.top > cords.bottom) {
				maxHeight = cords.top;
				placement = "top-";
			} else {
				placement = "bottom-";
			...
			// Decide if place the dropdown below or above the input
			if (maxWidth < this.menu.clientWidth + 20 && cords.left > cords.right) {
				placement += "left";
			} else {
				placement += "right";
			}
