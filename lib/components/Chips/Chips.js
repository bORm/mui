...
var Chips = (_temp = _class = function (_Component) {
  (0, _inherits3.default)(Chips, _Component);

  function Chips() {
    (0, _classCallCheck3.default)(this, Chips);
    return (0, _possibleConstructorReturn3.default)(this, (Chips.__proto__ || (0, _getPrototypeOf2.default)(Chips)).apply(this, arguments));
  }
