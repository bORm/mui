...
var PortalContent = (_temp = _class = function (_Component) {
   ...
   if (typeof this.props.onModalDidMount === 'function') {
	...
	function PortalContent(props) {
		...
		var _this = (0, _possibleConstructorReturn3.default)(this, (PortalContent.__proto__ || (0, _getPrototypeOf2.default)(PortalContent)).call(this, props));
   ...
   this.timer = setTimeout(()=>{
	...
	onModalWillUnmount: _react.PropTypes.func }, _class.defaultProps = {
	mountTo: 'modals',
	isOpen: false,
	toggle: {
...
var Portal = (_temp2 = _class2 = function (_Component2) {
	(0, _inherits3.default)(Portal, _Component2);

	function Portal(props) {
		(0, _classCallCheck3.default)(this, Portal);

		var _this3 = (0, _possibleConstructorReturn3.default)(this, (Portal.__proto__ || (0, _getPrototypeOf2.default)(Portal)).call(this, props));
	...
	(0, _createClass3.default)(Portal, [{
		...
		value: function render() {
			var _props2 = this.props,
			    id = _props2.id,
			    other = (0, _objectWithoutProperties3.default)(_props2, ['id']);
