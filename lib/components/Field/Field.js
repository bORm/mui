   ...
   */
		...
		value: function render() {
			...
			var _props3 = this.props,
			    ...
			    danger = _props3.danger,
			    className = _props3.className,
			    other = (0, _objectWithoutProperties3.default)(_props3, ['defaultValue', 'floating', 'placeholder', 'autoComplete', 'type', 'min', 'max', 'onChange', 'onFocus', 'onBlur', 'name', 'required', 'readOnly', 'disabled', 'large', 'small', 'block', 'success', 'warning', 'danger', 'className']);
   	...
   	this.setState({
   		value: e.target.value
			...
			var _props4 = this.props,
			    mask = _props4.mask,
			    alwaysShowMask = _props4.alwaysShowMask,
			    maskChar = _props4.maskChar,
			    formatChars = _props4.formatChars,
			    props = (0, _objectWithoutProperties3.default)(_props4, ['mask', 'alwaysShowMask', 'maskChar', 'formatChars']);
