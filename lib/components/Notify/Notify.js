...
var Notify = function (_Modal) {
	...
	(0, _createClass3.default)(Notify, [{
		...
		value: function render() {
			...
			var other = (0, _objectWithoutProperties3.default)(_props, ['id', 'size', 'className', 'style', 'closeButton', 'header', 'isOpen', 'onClose', 'mountTo']);
...
Notify.propTypes = (0, _extends3.default)({}, _Modal3.default.propTypes, {
	wait: _react.PropTypes.number.isRequired
});
Notify.defaultProps = (0, _extends3.default)({}, _Modal3.default.defaultProps, {
	mountTo: 'notifies',
	wait: 5000
});
Notify.wait = null;
