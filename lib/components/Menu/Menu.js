	...
	(0, _createClass3.default)(Menu, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    other = (0, _objectWithoutProperties3.default)(_props, ['control', 'className', 'isOpen', 'disableOnClickOutside', 'enableOnClickOutside', 'handleClickOutside', 'zDepth']);
	...
	(0, _createClass3.default)(Item, [{
		...
		value: function render() {
			var _props2 = this.props,
			    ...
			    other = (0, _objectWithoutProperties3.default)(_props2, ['text', 'value', 'className', 'children', 'onClick', 'ripple']);
