...
var SelectionGroup = (_temp = _class = function (_Component) {
  (0, _inherits3.default)(SelectionGroup, _Component);

  function SelectionGroup() {
    (0, _classCallCheck3.default)(this, SelectionGroup);
    return (0, _possibleConstructorReturn3.default)(this, (SelectionGroup.__proto__ || (0, _getPrototypeOf2.default)(SelectionGroup)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(SelectionGroup, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = (0, _objectWithoutProperties3.default)(_props, ['text', 'value', 'className', 'children', 'onClick', 'ripple']);
