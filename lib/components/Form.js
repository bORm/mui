  ...
  (0, _createClass3.default)(Form, [{
    ...
    value: function onSubmit() {
      ...
      if (!disabled) {
        ...
        var _form = this.form;
        var data = _form.data;
        var validation = _form.validation;
    ...
    value: function submit() {
      ...
      var data = _form2.data;
      var validation = _form2.validation;
    ...
    value: function getFormElements(children) {
      ...
      var validation = _state.validation;
...
Form.defaultProps = {
  ...
  names: {},
  onSubmit: function onSubmit(e, data, validation) {},
  //ref: 'form',
  disabled: false
};
